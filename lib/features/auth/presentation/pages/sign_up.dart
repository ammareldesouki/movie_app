...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Register",style: Theme.of(context).textTheme!.titleLarge!.copyWith(color: TColors.primary),),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
                ...
                child: ElevatedButton(onPressed: (){}, child: Text("Create An Account",style: Theme.of(context).textTheme.titleMedium,))),


            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Already Have Account ? ",style: Theme.of(context).textTheme.bodySmall!.copyWith(color: Colors.white),),
                InkWell(
                  onTap: (){
