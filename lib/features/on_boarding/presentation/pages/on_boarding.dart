            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Create Watchlists",style: Theme.of(context).textTheme.titleLarge!.copyWith(color: Colors.white),textAlign: TextAlign.center),

                    Expanded(child: Text("Save movies to your watchlist to keep track of what you want to watch next. Enjoy films in various qualities and genres.",style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.white),textAlign: TextAlign.center,)),
                    ...
                    }, child: Text(isLastPage?"Finish" :"Next",style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.black))),
                    SizedBox(height: 16,),
                    ?isFirstPage ? null :
                    Container(
                      decoration: BoxDecoration(
                      ...
                      child:   ElevatedButton(
                          style:Theme.of(context).elevatedButtonTheme!.style?.copyWith(backgroundColor:WidgetStateProperty.all(Colors.transparent)),
                          onPressed: (){
                            ...
                            }}, child: Text("Back",style: Theme.of(context).textTheme.titleMedium!.copyWith(color: TColors.primary))),
                    ),
